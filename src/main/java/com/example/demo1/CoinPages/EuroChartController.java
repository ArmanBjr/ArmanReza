...
public class EuroChartController {
    ...
    private void updateChart() {
        if (situ == 2) {
            ...
            for (int i = 23; i >= 0; i--) {
                ...
                String query = "SELECT AVG(euro) as avg_euro FROM currency_rates WHERE " +
                ...
                try (Connection conn = DataBase.connectDb();
                    ...
                    if (rs.next()) {
                        double avgPrice = rs.getDouble("avg_euro");
    ...
    private void updateChartForLast30Days() {
        ...
        for (int i = 29; i >= 0; i--) {
            ...
            String query = "SELECT AVG(euro) as avg_euro FROM currency_rates WHERE date = '" + dateString + "'";
    ...
    public void updateLabels() {
        try (Connection connection = DataBase.connectDb()) {
            ...
            if (resultSet.next()) {
                ...
                Price.setText(String.valueOf(euro));
                LowestPrice.setText(String.valueOf(Values.getLowestPrice(connection, "euro", formattedDate, formattedTime)));
                HighestPrice.setText(String.valueOf(Values.getHighestPrice(connection, "euro", formattedDate, formattedTime)));
                ChangePercentage.setText(String.valueOf(Values.getChangePercentage(connection, "euro", formattedDate, formattedTime)));
                if (Values.getChangePercentage(connection, "euro", formattedDate, formattedTime) >= 0) {
